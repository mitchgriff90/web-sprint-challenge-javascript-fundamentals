...
/* Use summation to do the following:
    1. Receive a number 
    2. Use a counter to return the s ummation of that number. 
...
const zooAnimals = [
 ...
 let tacos = [];
 zooAnimals.forEach(element => tacos.push(element.animal_name.toLowerCase()))
 return tacos;
  }
  ...
  */
  ...
  function USApop(zooAnimals){
     return zooAnimals.reduce(function (acc, curr){return acc + curr.population;},0);
  }
...
function multiply(a, b){
 ...
 function greeting(tacos, pizza){
  return ('Hello ' + tacos + ' ' + pizza +', nice to meet you!')
 }
